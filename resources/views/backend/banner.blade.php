                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content">
                            <form
                                action="@if ($banner) {{ route('banner', $banner->id) }} @else {{ route('banner') }} @endif"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="@if ($banner) {{ old('name', $banner->name) }} @endif">
                                                </div>
                                            </fieldset>
                                        </div>
                                        {{-- <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="type" id="type" class="form-control">
                                                        <option
                                                            @if ($banner) @if ($banner->type == 'image')
                                                selected @endif
                                                            @endif value="image">Image</option>
                                                        <option
                                                            @if ($banner) @if ($banner->type == 'video')
                                                selected @endif
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="file" class="form-control"
                                                        ...
                                                        value="@if ($banner) {{ old('image', $banner->image) }} @endif"
                                                        onchange="loadFile(event)">
                                                </div>
                                            </fieldset>
                                            @if ($banner)
                                                @if ($banner->image != null)
                                                    <image src="{{ asset('images/banner/' . $banner->image) }}"
                                        ...
                                        {{-- <div class="col-md-6">
                                            <fieldset>
                                                <h5>Video<span class="star">*</span></h5>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-Createon1"><i
                                                                class="bx bx-file"></i></span>
                                                    ...
                                                    <input type="text" class="form-control"
                                                        aria-describedby="basic-Createon1" name="video"
                                                        value="@if ($banner) {{ old('video', $banner->video) }} @endif"
                                                        onchange="loadFile(event)">
                                                </div>
                                            </fieldset>
                                            @if ($banner)
                                                @if ($banner->video != null)
                                                    <iframe src="{{ asset('images/banner/' . $banner->video) }}"
                                                        type="video/mp4" controls id="bg" class="mt-2 mx-1"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="status" id="" class="form-control">
                                                        <option
                                                            @if ($banner) @if ($banner->status == 'Active')
                                                selected @endif
                                                            @endif value="Active">Active</option>
                                                        <option
                                                            @if ($banner) @if ($banner->status == 'Inactive')
                                                selected @endif
                                            ...
                                            @if ($banner)
                                                @foreach ($banners as $banner)
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="{{ route('banner', $banner->id) }}">{{ $banner->name }}</a>
                                                        </td>
                                                        {{-- <td>{{ $banner->type }}</td> --}}
                                                        ...
                                                        {{-- <td class="text-bold-600">
                                                            <iframe src="{{ asset('images/banner/' . $banner->video) }}"
                                                                type="video/mp4" controls id="bg"
                                                                class="mt-2 mx-1" width="200px" height="200px">
                                                            </iframe>
