                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item active">Sustainability Section
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content">
                            <form
                                action="@if ($sustainability) {{ route('admin-sustainability', $sustainability->id) }} @else {{ route('admin-sustainability') }} @endif"
                                        ...
                                        <div class="col-md-6 col-lg-12">
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="first_content" rows="3" name="first_content">{{ $sustainability->first_content }}</textarea>
                                            </fieldset>
                                        ...
                                        <div class="col-md-6 col-lg-12">
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="second_content" rows="3" placeholder="" name="second_content">{{ $sustainability->second_content }}
                                                    </textarea>
                                            </fieldset>
                                        </div>
                                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Sustainability List</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration">
                                    ...
                                    <tbody>
                                        @if ($sustainability)
                                            <tr>
                                                <td><a href="{{ route('admin-sustainability', $sustainability->id) }}">
                                                        {{ $sustainability->title }}</a>
                                                </td>
                                                <td>{!! Str::words($sustainability->first_content, 20) !!}
                                                </td>
                                                <td>{!! Str::words($sustainability->second_content, 20) !!}</td>
...
@section('js')
    ...
    <script>
        ClassicEditor
            .create(document.querySelector('#first_content'))
            .catch(error => {
                console.error(error);
            });
    </script>
    <script>
        ClassicEditor
            .create(document.querySelector('#second_content'))
            .catch(error => {
                console.error(error);
            });
    </script>
