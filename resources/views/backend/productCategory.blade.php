            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Product Category Section
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form
                            action="@if ($productCategory) {{ route('product-category', $productCategory->id) }} @else {{ route('product-category') }} @endif"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="@if ($productCategory) {{ old('name', $productCategory->name) }} @endif">
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" class="form-control"
                                                    ...
                                                    value="@if ($productCategory) {{ old('image', $productCategory->image) }} @endif"
                                                    onchange="loadFile(event)">
                                            </div>
                                        </fieldset>
                                        @if ($productCategory)
                                        @if ($productCategory->image != null)
                                        <img src="{{ asset('images/productCategory/' . $productCategory->image) }}"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="status" id="" class="form-control">
                                                    <option @if ($productCategory) @if ($productCategory->status ==
                                                        'Active')
                                                        selected @endif
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a
                                                    href="{{ route('product-category', $productCategory->id) }}">{{ $productCategory->name }}</a>
                                            </td>

                                            <td class="text-bold-600"><img
                                                    src="{{ asset('images/productCategory/' . $productCategory->image) }}"
                                                    alt="" height="150px"></td>
