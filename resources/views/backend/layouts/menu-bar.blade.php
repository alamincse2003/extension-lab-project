 ...
 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
     ...
     <div class="main-menu-content">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
             data-icon-style="">
             <li class=" nav-item"><a href="{{ route('home') }}"><i class="bx bx-home-alt"></i><span
                         class="menu-title" data-i18n="Dashboard">Website</span><span
             ...
             <li class=" nav-item"><a href="{{ route('company') }}"><i class="bx bx-envelope"></i><span
                         class="menu-title" data-i18n="Email">Company</span></a>
             </li>
             <li class=" nav-item"><a href="{{ route('admin-sustainability') }}"><i class="bx bx-chat"></i><span
                         class="menu-title" data-i18n="Chat">Sustainability</span></a>
             </li>
             ...
             <li class=" nav-item"><a href="{{ route('setting') }}"><i class="bx bx-calendar"></i><span
                         class="menu-title" data-i18n="Calendar">Settings</span></a>
             </li>
